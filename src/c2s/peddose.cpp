              ...
              const std::string &language)
{
    ...
    try {
        BOOST_FOREACH(pt::ptree::value_type &v, tree.get_child("SwissPedDosePublicationV4")) {
            if (v.first == "Cases") {
        ...
        i = 0;
        BOOST_FOREACH(pt::ptree::value_type &v, tree.get_child("SwissPedDosePublicationV4.Cases")) {
            if (v.first == "Case") {
#if 0
        ...
        i = 0;
        BOOST_FOREACH(pt::ptree::value_type &v, tree.get_child("SwissPedDosePublicationV4.Indications")) {
        ...
        i = 0;
        BOOST_FOREACH(pt::ptree::value_type &v, tree.get_child("SwissPedDosePublicationV4.Codes")) {
            if (v.first == "Code") {
        ...
        i = 0;
        BOOST_FOREACH(pt::ptree::value_type &v, tree.get_child("SwissPedDosePublicationV4.Dosages")) {
            if (v.first == "Dosage") {
